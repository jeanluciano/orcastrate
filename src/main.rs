use kameo::prelude::*;
use orcastra::worker::{Worker, StartTask};
use orcastra::processors::redis::Processor;
use uuid::Uuid;
use tokio::time;
...
async fn main() {
    ...
    let start_msg1 = StartTask { task_name: task1_name };
    ...
    let start_msg2 = StartTask { task_name: task2_name };
