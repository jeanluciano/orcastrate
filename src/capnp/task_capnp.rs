...
pub mod task {
  ...
  pub type CallParams<> = ::capnp::capability::Params<crate::task_capnp::task::call_params::Owned>;
  pub type CallResults<> = ::capnp::capability::Results<crate::task_capnp::task::call_results::Owned>;
  pub type CancelParams<> = ::capnp::capability::Params<crate::task_capnp::task::cancel_params::Owned>;
  pub type CancelResults<> = ::capnp::capability::Results<crate::task_capnp::task::cancel_results::Owned>;
  ...
  impl  Client {
    pub fn call_request(&self) -> ::capnp::capability::Request<crate::task_capnp::task::call_params::Owned,crate::task_capnp::task::call_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, None)
    }
    pub fn cancel_request(&self) -> ::capnp::capability::Request<crate::task_capnp::task::cancel_params::Owned,crate::task_capnp::task::cancel_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 1, None)
    }
  }
  pub trait Server<>   {
    fn call(&mut self, _: CallParams<>, _: CallResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method task::Server::call not implemented".to_string())) }
    fn cancel(&mut self, _: CancelParams<>, _: CancelResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method task::Server::cancel not implemented".to_string())) }
  }
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xda5a_c297_29c9_24b7;
  }
  ...
  pub mod task_arg {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0x98e5_d4d5_5a7c_a3e0;
    }
  }
  ...
  impl ::capnp::traits::FromU16 for TaskStatus {
    #[inline]
    fn from_u16(value: u16) -> ::core::result::Result<TaskStatus, ::capnp::NotInSchema> {
      match value {
        0 => ::core::result::Result::Ok(TaskStatus::Submitted),
        1 => ::core::result::Result::Ok(TaskStatus::Working),
        2 => ::core::result::Result::Ok(TaskStatus::Completed),
        3 => ::core::result::Result::Ok(TaskStatus::Cancelled),
        4 => ::core::result::Result::Ok(TaskStatus::Failed),
        5 => ::core::result::Result::Ok(TaskStatus::Unknown),
        n => ::core::result::Result::Err(::capnp::NotInSchema(n)),
      }
    }
  }
  impl ::capnp::traits::ToU16 for TaskStatus {
    #[inline]
    fn to_u16(self) -> u16 { self as u16 }
  }
  impl ::capnp::traits::HasTypeId for TaskStatus {
    #[inline]
    fn type_id() -> u64 { 0xb012_07dd_8ae6_e134u64 }
  }
  ...
  pub mod task {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_status(self) -> ::core::result::Result<crate::task_capnp::task::TaskStatus,::capnp::NotInSchema> {
        ::capnp::traits::FromU16::from_u16(self.reader.get_data_field::<u16>(0))
      }
      #[inline]
      pub fn get_args(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::task_capnp::task::task_arg::Owned>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
      }
      #[inline]
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_status(&mut self, value: crate::task_capnp::task::TaskStatus)  {
        self.builder.set_data_field::<u16>(0, value as u16)
      }
      #[inline]
      pub fn get_args(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::task_capnp::task::task_arg::Owned>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_args(&mut self, value: ::capnp::struct_list::Reader<'a,crate::task_capnp::task::task_arg::Owned>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(1), value, false)
      }
      #[inline]
      pub fn init_args(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::task_capnp::task::task_arg::Owned> {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0xfeac_648d_acbd_e0dc;
    }
  }
  ...
  pub mod call_params {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0xaaa6_a72d_fb89_832d;
    }
  }
  ...
  pub mod call_results {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0xe29d_0e4f_665a_58c8;
    }
  }
  ...
  pub mod cancel_params {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 0 };
      pub const TYPE_ID: u64 = 0xe7fb_28d8_1600_34b3;
    }
  }
  ...
  pub mod cancel_results {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 0 };
      pub const TYPE_ID: u64 = 0xe490_46e3_753f_0898;
    }
  }
}
